...
function escribirHTML(grupo, matriz, id) {
    ...
    matriz.forEach((preguntaActual, numeroPregunta) => {
        ...
        for (letraRespuesta in preguntaActual.respuestas) {
            ...
            respuestas.push(
                `<td align="center"><label> 
                    <input type="checkbox" onchange="desactivarNP('g${grupo}sg${subgrupo}p${contador}r${letraRespuesta}', 'g${grupo}sg${subgrupo}p${auxCon1}r${letraRespuesta}','g${grupo}sg${subgrupo}p${auxCon2}r${letraRespuesta}', 'g${grupo}sg${subgrupo}p${auxCon1}r${auxLetra}','g${grupo}sg${subgrupo}p${auxCon2}r${auxLetra}');" onclick="beLikeRadio('g${grupo}sg${subgrupo}p${contador}r${auxLetra}'); " name="g${grupo}p${preguntaActual.letra}r${letraRespuesta}" id="g${grupo}sg${subgrupo}p${contador}r${letraRespuesta}" value="1" required>
                </label></td>
                `
            );
        }
