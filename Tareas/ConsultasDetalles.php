...
function obtenermenu($idUni)
{
 ...
 <ul class="list-group">
     <li>';
        ...
        echo '<button type="button" class=" btn btn-md buttonm " onclick="mostrar(`Bienvenida`);">
             <img src="SeccionAdministrativa/img/Inicio/escuela.png" class=" rounded "></img><span>Bienvenida</span>
         </button>';
...
function obtenerBienvenida($idUni)
{
    ...
    ';
        ...
        echo '<h2>No se encontro video de bienvenida</h2>';
    }
}
        ...
        <br>  
         ...
         FROM `foto` 
            ...
            <br>';
                ...
                echo '<h2 class="text-center"> No se han subido fotos en esta seccion</h2> </div>';
            }
        }
    } else {
        echo ' <div><h2 class="text-center"> No se han subido fotos </h2> </div> ';
    }
}
         ...
         FROM `video` 
           ...
           <div class=" text-muted">
            ...
            <br>';
                ...
                echo '<h2 class="text-center"> No se han subido videos en esta seccion</h2> </div>';
            }
        }
    }
    if(!$x && !$y){
            echo ' <div><h2 class="text-center"> No se han subido videos </h2> </div>';
    }
}
function obtenerAdmision($idUni)
{
    ...
    if (mysqli_num_rows($results) > 0) {
        ...
        <h2 class="text-center">Admisiones</h2>
        <hr>
        <br>
...
{
    echo '<h2 class="text-center"> Contacto</h2>
    <hr>';
    $conexion = conexion10();
...
function obtenerBecas($idUni)
{
    ...
    ";
        ...
        echo '<h2 class="text-center col-12">Esta universidad no cuenta con becas o no se han subido la información</h2>';
    }
}
function obtenerOferta($idUni)
{
    ...
    if (mysqli_num_rows($results) > 0) {
        ...
        echo   " <h3 class='text-center'> No hay carreras por el momento...</h3>
        <hr>";
    }
}
