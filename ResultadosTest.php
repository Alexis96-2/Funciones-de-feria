                ...
                switch ($_POST['genero']) {
                    ...
                    case 1:
                        ...
                        if ($puntajeCa <= 16) {
                            ...
                            $centilCi  = 55;
                        } else if ($puntajeCa <= 42) {
                            $centilCi  = 60;
                        } else if ($puntajeCa <= 43) {
                            $centilCi  = 65;
                        } else if ($puntajeCa <= 45) {
                            $centilCi  = 70;
                        } else if ($puntajeCa <= 47) {
                            $centilCi  = 75;
                        } else if ($puntajeCa <= 48) {
                            $centilCi  = 80;
                        } else if ($puntajeCa <= 51) {
                            $centilCi  = 85;
                        } else if ($puntajeCa <= 54) {
                            $centilCi  = 90;
                        } else if ($puntajeCa <= 56) {
                            $centilCi  = 95;
                        } else if ($puntajeCa <= 57) {
                            $centilCi  = 96;
                        } else if ($puntajeCa <= 59) {
                            $centilCi  = 97;
                        } else if ($puntajeCa <= 61) {
                            $centilCi  = 98;
                        } else if ($puntajeCa <= 70) {
                            $centilCi  = 99;
                        }
                        //Persuasiva
                        if ($puntajePe <= 16) {
