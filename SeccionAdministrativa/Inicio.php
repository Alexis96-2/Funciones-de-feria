...
<body>
    ...
    $imgOpciones = array(
        "img/Inicio/escuela.png",
        "img/Inicio/documentos.png",
        "img/Inicio/usuario.svg",
        "img/Inicio/archivos.svg",
        "img/Inicio/camara-de-video.svg",
        "img/Inicio/img.svg",
        "img/Inicio/educacion.svg",
        "img/Inicio/agenda.svg",
        "img/Inicio/conferencia.svg",
    );
