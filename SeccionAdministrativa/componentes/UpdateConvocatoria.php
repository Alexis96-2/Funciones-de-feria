...
function UpdateModalConvocatoria()
...
<div class="modal fade bd-example-modal-xl" id="ModalUpdateConvocatoria" tabindex="-1"
  ...
  <div class="modal-dialog modal-xl" role="document">
    ...
    <div class="modal-content container">
      ...
      <div class="modal-header ">
        ...
        <h5 class="modal-title text-center" id="EditarArchivoLabel">Editar Convocatoria</h5>
  ...
  <br>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12 d-flex justify-content-end">
            ...
            <input type="hidden" name="CONFIG" value="Convocatoria" />
